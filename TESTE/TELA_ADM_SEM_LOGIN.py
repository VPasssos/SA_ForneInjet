...
from CRUD_INJETORA import *
from CRUD_FORNECEDOR import *
from CRUD_FUNCIONARIO import *
from CRUD_CLIENTE import *
from CRUD_VENDA import *
...
# Código para executar diretamente
if __name__ == "__main__":
    root = tk.Tk()
    app = TELA_ADM(root, id_funcionario=1)  # ID 1 para admin
    root.mainloop()