...
INSERT INTO Injetora (marca, modelo, tipo_de_controle, capacidade_de_injecao, forca_de_fechamento, preco_medio_USD, preco_medio_BRL, quantidade, observacao, ID_Fornecedor) VALUES
('Arburg', 'Allrounder 470 E Golden Edition', 'Elétrica', 200, 500, 180000.00, 900000.00, 3, 'Máquina premium com controle SELOGICA', 1),
('Engel', 'Victory 200/50 Tech', 'Elétrica', 180, 450, 175000.00, 875000.00, 2, 'Tecnologia CC300 com baixo consumo', 2),
('Husky', 'HyPET 300/120', 'Híbrida', 300, 800, 280000.00, 1400000.00, 1, 'Especializada para embalagens PET', 3),
('Milacron', 'Elektron EVO 150', 'Elétrica', 150, 350, 135000.00, 675000.00, 4, 'Versão EVO com melhorias técnicas', 4),
('Wittmann', 'EcoPower 250/80', 'Elétrica', 250, 600, 210000.00, 1050000.00, 2, 'Sistema de energia recuperativa', 5),
('Arburg', 'Allrounder 370 S', 'Hidráulica', 150, 400, 120000.00, 600000.00, 5, 'Modelo básico para produção contínua', 1),
('Engel', 'E-motion 170/60 TL', 'Elétrica', 170, 600, 160000.00, 800000.00, 3, 'Tecnologia de moldagem por injeção de 2 componentes', 2);
...
INSERT INTO Compra (ID_Fornecedor, ID_Funcionario, data_compra, data_entrega_prevista, data_entrega_real, status_compra, forma_pagamento, valor_total_USD, valor_total_BRL, numero_nota_fiscal, observacoes) VALUES
(1, 3, '2023-01-15', '2023-02-20', '2023-02-18', 'concluido', 'Boleto 30 dias', 360000.00, 1800000.00, 'NF123456', 'Compra de 2 máquinas Arburg Allrounder 470'),
(2, 3, '2023-02-10', '2023-03-15', '2023-03-12', 'concluido', 'Cartão de Crédito', 350000.00, 1750000.00, 'NF234567', 'Compra de 2 máquinas Engel Victory'),
(3, 3, '2023-03-05', '2023-04-10', NULL, 'processamento', 'Transferência Bancária', 280000.00, 1400000.00, NULL, 'Máquina Husky em processo de importação'),
(4, 3, '2023-04-20', '2023-05-25', '2023-05-22', 'concluido', 'Financiamento', 540000.00, 2700000.00, 'NF345678', 'Compra de 4 máquinas Milacron Elektron'),
(5, 3, '2023-05-12', '2023-06-17', NULL, 'pendente', 'Boleto 60 dias', 420000.00, 2100000.00, NULL, 'Aguardando aprovação financeira');
INSERT INTO ItemCompra (ID_Compra, ID_Injetora, quantidade, preco_unitario_BRL, preco_unitario_USD) VALUES
(1, 1, 2, 900000.00, 180000.00),
(2, 2, 2, 875000.00, 175000.00),
(3, 3, 1, 1400000.00, 280000.00),
(4, 4, 4, 675000.00, 135000.00),
(5, 5, 2, 1050000.00, 210000.00);
INSERT INTO Venda (ID_Cliente, ID_Funcionario, data_venda, forma_pagamento, valor_total_BRL, valor_total_USD, observacoes, status_aprovacao, aprovado_por, data_aprovacao, justificativa_status) VALUES
(1, 2, '2023-02-01', 'Financiamento', 900000.00, 180000.00, 'Venda de máquina Arburg Allrounder 470', 'Em análise', 1, '2023-02-01 10:30:00', 'Cliente com bom histórico de pagamentos'),
(2, 2, '2023-03-15', 'Boleto 30 dias', 875000.00, 175000.00, 'Venda de máquina Engel Victory', 'Em análise', 1, '2023-03-15 14:15:00', 'Pagamento à vista com desconto'),
(3, 2, '2023-04-10', 'Cartão de Crédito', 1400000.00, 280000.00, 'Venda de máquina Husky HyPET', 'Em análise', NULL, NULL, NULL),
(4, 2, '2023-05-20', 'Transferência Bancária', 675000.00, 135000.00, 'Venda de máquina Milacron Elektron', 'Em análise', 1, '2023-05-20 16:45:00', 'Cliente com restrição cadastral'),
(5, 2, '2023-06-05', 'Boleto 60 dias', 1050000.00, 210000.00, 'Venda de máquina Wittmann EcoPower', 'Em análise', 1, '2023-06-05 11:20:00', 'Cliente com garantia adicional');
INSERT INTO ItemVenda (ID_Venda, ID_Injetora, quantidade, preco_unitario_BRL, preco_unitario_USD) VALUES
(1, 1, 1, 900000.00, 180000.00),
(2, 2, 1, 875000.00, 175000.00),
(3, 3, 1, 1400000.00, 280000.00),
(4, 4, 1, 675000.00, 135000.00),
(5, 5, 1, 1050000.00, 210000.00);
